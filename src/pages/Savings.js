...
const questions = [
  {
    ...
    ans:
      "You can register by simply paying a non-refundable fee of #2,000:00 to any of our account officers. Request and receive a receipt, then an account number will be generated and sent to you.",
  },
  {
    text: "How do I start saving?",
    ans:
      "You can register by simply paying a non-refundable fee of #2,000:00 to any of our account officers. Receive your receipt, then an account number will be generated and sent to you. (Always ensure you collect a receipt for any payment you make) You can also make payments directly to the company’s account. Then, send proof of payments to our account officers through our e-mail contacts.",
  },
  {
    text: "Can I access more than 150% of my savings?",
    ans:
      "Yes. You can access more than 150% of your savings. Once you save 30% of the amount you want to collect with us, you can access the loan.",
  },
];
const Savings = () => {
  return (
    <Layout>
      ...
      />
      {questions.map((item) => {
        return <Accordion question={item.text} answer={item.ans} />;
      })}
    </Layout>
  );
};
